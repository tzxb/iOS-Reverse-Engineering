#line 1 "/Users/paigu/Documents/AiMeiJu/AiMeiJuDylib/Logos/AiMeiJuDylib.xm"
...
@class XMDanmuModel; @class XMFilmDetailController; @class BarrageCanvas; @class KLCPopup; @class ZFLandScapeControlView; @class XMsetModel; @class XMUser; @class XMADSView; @class XMFilemListHeaderView; @class XMFilmModel; @class XMTaskViewController; @class AppDelegate; @class ZFPortraitControlView; 
